...
You can use the [editor on GitHub](https://github.com/JedTyde/Game-Installer-Creation/edit/main/docs/index.md) to maintain and preview the content for your website in Markdown files.
